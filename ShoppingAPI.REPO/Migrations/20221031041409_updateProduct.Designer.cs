...
namespace ShoppingAPI.REPO.Migrations
{
    ...
    [Migration("20221031041409_updateProduct")]
            ...
            modelBuilder.Entity("ShoppingAPI.Data.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 10, 31, 11, 14, 9, 324, DateTimeKind.Local).AddTicks(2896),
                            IsTrash = false,
                            Name = "SuperAdmin"
                        });
                });
            ...
            modelBuilder.Entity("ShoppingAPI.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 10, 31, 11, 14, 9, 324, DateTimeKind.Local).AddTicks(3706),
                            IsTrash = false,
                            LastName = "Admin",
            ...
            modelBuilder.Entity("ShoppingAPI.Data.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 10, 31, 11, 14, 9, 324, DateTimeKind.Local).AddTicks(3771),
                            IsTrash = false,
                            RoleId = 1,
                            UserId = 1
                        });
