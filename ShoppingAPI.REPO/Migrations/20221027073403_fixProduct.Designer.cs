...
namespace ShoppingAPI.REPO.Migrations
{
    ...
    [Migration("20221027073403_fixProduct")]
            ...
            modelBuilder.Entity("ShoppingAPI.Data.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 10, 27, 14, 34, 3, 91, DateTimeKind.Local).AddTicks(5297),
                            IsTrash = false,
                            Name = "SuperAdmin"
                        });
                });
            ...
            modelBuilder.Entity("ShoppingAPI.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 10, 27, 14, 34, 3, 91, DateTimeKind.Local).AddTicks(6108),
                            IsTrash = false,
                            LastName = "Admin",
            ...
            modelBuilder.Entity("ShoppingAPI.Data.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 10, 27, 14, 34, 3, 91, DateTimeKind.Local).AddTicks(6173),
                            IsTrash = false,
                            RoleId = 1,
                            UserId = 1
                        });
