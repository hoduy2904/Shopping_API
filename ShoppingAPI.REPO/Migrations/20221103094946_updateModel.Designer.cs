...
namespace ShoppingAPI.REPO.Migrations
{
    ...
    [Migration("20221103094946_updateModel")]
            ...
            modelBuilder.Entity("ShoppingAPI.Data.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 11, 3, 16, 49, 46, 423, DateTimeKind.Local).AddTicks(1533),
                            IsTrash = false,
                            Name = "SuperAdmin"
                        });
                });
            ...
            modelBuilder.Entity("ShoppingAPI.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 11, 3, 16, 49, 46, 423, DateTimeKind.Local).AddTicks(2521),
                            IsTrash = false,
                            LastName = "Admin",
            ...
            modelBuilder.Entity("ShoppingAPI.Data.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 11, 3, 16, 49, 46, 423, DateTimeKind.Local).AddTicks(2592),
                            IsTrash = false,
                            RoleId = 1,
                            UserId = 1
                        });
