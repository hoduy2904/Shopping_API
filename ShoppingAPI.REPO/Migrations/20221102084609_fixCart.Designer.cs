...
namespace ShoppingAPI.REPO.Migrations
{
    ...
    [Migration("20221102084609_fixCart")]
            ...
            modelBuilder.Entity("ShoppingAPI.Data.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 11, 2, 15, 46, 9, 49, DateTimeKind.Local).AddTicks(3300),
                            IsTrash = false,
                            Name = "SuperAdmin"
                        });
                });
            ...
            modelBuilder.Entity("ShoppingAPI.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 11, 2, 15, 46, 9, 49, DateTimeKind.Local).AddTicks(4142),
                            IsTrash = false,
                            LastName = "Admin",
            ...
            modelBuilder.Entity("ShoppingAPI.Data.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 11, 2, 15, 46, 9, 49, DateTimeKind.Local).AddTicks(4216),
                            IsTrash = false,
                            RoleId = 1,
                            UserId = 1
                        });
