...
namespace ShoppingAPI.REPO.Migrations
{
    ...
    [Migration("20221103095937_fixTypeName")]
            ...
            modelBuilder.Entity("ShoppingAPI.Data.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 11, 3, 16, 59, 37, 409, DateTimeKind.Local).AddTicks(3234),
                            IsTrash = false,
                            Name = "SuperAdmin"
                        });
                });
            ...
            modelBuilder.Entity("ShoppingAPI.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 11, 3, 16, 59, 37, 409, DateTimeKind.Local).AddTicks(4141),
                            IsTrash = false,
                            LastName = "Admin",
            ...
            modelBuilder.Entity("ShoppingAPI.Data.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 11, 3, 16, 59, 37, 409, DateTimeKind.Local).AddTicks(4222),
                            IsTrash = false,
                            RoleId = 1,
                            UserId = 1
                        });
