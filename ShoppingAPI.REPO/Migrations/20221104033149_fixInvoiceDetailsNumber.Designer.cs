...
namespace ShoppingAPI.REPO.Migrations
{
    ...
    [Migration("20221104033149_fixInvoiceDetailsNumber")]
    partial class fixInvoiceDetailsNumber
    {
            ...
            modelBuilder.Entity("ShoppingAPI.Data.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 11, 4, 10, 31, 49, 454, DateTimeKind.Local).AddTicks(3700),
                            IsTrash = false,
                            Name = "SuperAdmin"
                        });
                });
            ...
            modelBuilder.Entity("ShoppingAPI.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 11, 4, 10, 31, 49, 454, DateTimeKind.Local).AddTicks(4621),
                            IsTrash = false,
                            LastName = "Admin",
            ...
            modelBuilder.Entity("ShoppingAPI.Data.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 11, 4, 10, 31, 49, 454, DateTimeKind.Local).AddTicks(4693),
                            IsTrash = false,
                            RoleId = 1,
                            UserId = 1
                        });
