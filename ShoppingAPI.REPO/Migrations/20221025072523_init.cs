    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InfomationUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InfomationUsers_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductVariateId = table.Column<int>(type: "int", nullable: true),
                    IsTrash = table.Column<bool>(type: "bit", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductVarationId = table.Column<int>(type: "int", nullable: false),
                    Number = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "Created", "IsTrash", "Name" },
                values: new object[] { 1, new DateTime(2022, 10, 25, 14, 25, 22, 980, DateTimeKind.Local).AddTicks(3907), false, "SuperAdmin" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Created", "Email", "FristName", "IdentityCard", "IsTrash", "LastName", "PasswordHash", "Sex", "Username" },
                values: new object[] { 1, new DateTime(2022, 10, 25, 14, 25, 22, 980, DateTimeKind.Local).AddTicks(4608), null, null, null, false, "Admin", "21232f297a57a5a743894a0e4a801fc3", false, "Admin" });

            migrationBuilder.InsertData(
                table: "UserRoles",
                columns: new[] { "Id", "Created", "IsTrash", "RoleId", "UserId" },
                values: new object[] { 1, new DateTime(2022, 10, 25, 14, 25, 22, 980, DateTimeKind.Local).AddTicks(4671), false, 1, 1 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InfomationUsers_UserId",
